    ...
    <footer className="bg-ink px-5 pt-14 pb-8 text-silver">
      <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="text-sm">
            {quickLinks.map((l) => (
              <li key={l.label}>
                <Link to={l.to} className="inline-block py-1.5 hover:text-background">
                  {l.label}
                </Link>
              </li>
            ))}
      ...
      <div className="mx-auto mt-12 w-full max-w-6xl border-t border-silver/20 pt-6">
        <p className="text-xs text-silver-deep">
          ...
          <Link to="/privacy" className="inline-block py-1.5 hover:text-background">
            Privacy Policy
          </Link>{" "}
          |{" "}
          <Link to="/terms" className="inline-block py-1.5 hover:text-background">
            Terms of Use
          </Link>{" "}
          |{" "}
          <Link to="/disclaimer" className="inline-block py-1.5 hover:text-background">
            Disclaimer
          </Link>
        </p>
