...
import silverEagle from "@/assets/silver-eagle.jpg";
import morganDollar from "@/assets/morgan-dollar.jpg";
import peaceDollar from "@/assets/peace-dollar.jpg";
import mapleLeaf from "@/assets/maple-leaf.jpg";
import bar10oz from "@/assets/bar-10oz.jpg";
import bar100oz from "@/assets/bar-100oz.jpg";
import junkSilver from "@/assets/junk-silver.jpg";
import silverRounds from "@/assets/silver-rounds.jpg";

export const Route = createFileRoute("/physical-silver")({
  component: PhysicalSilver,
  head: () => ({
    ...pageHead({
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(breadcrumbSchema("/physical-silver", "Physical Silver")),
      },
    ],
  }),
});
