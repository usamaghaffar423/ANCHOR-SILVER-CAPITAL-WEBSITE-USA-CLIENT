...
import silverStack from "@/assets/silver-stack.jpg";
import silverStackMobile from "@/assets/silver-stack-mobile.jpg";
import texSilver from "@/assets/tex-silver.jpg";
import texCurrency from "@/assets/tex-currency.jpg";
import texVault from "@/assets/tex-vault.jpg";
import { AnchorGlyph } from "@/components/brand/AnchorMark";
import { MarketBar, useMarket } from "@/components/site/market";
  ...
  return (
    <>
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-0 md:gap-8 lg:grid-cols-[1.15fr_1fr] lg:items-center lg:gap-12">
          <div className="flex min-w-0 flex-col pb-1 md:pb-0">
            ...
            <div className="mt-3 flex flex-col gap-2 sm:flex-row md:mt-4 md:gap-3">
              <Link to="/silver-ira" className={buttonStyles.primary}>
                Explore Silver IRA
              </Link>
              <Link to="/physical-silver" className={buttonStyles.outlineLight}>
                Buy Physical Silver
              </Link>
            </div>
      ...
      <Section className="md:py-24">
        ...
        <div className="mt-10">
          <Link to="/get-started" className={buttonStyles.primary}>
            Get Started Today
          </Link>
        </div>
      </Section>
