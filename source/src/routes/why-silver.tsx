...
export const Route = createFileRoute("/why-silver")({
  component: WhySilver,
  head: () => ({
    ...pageHead({
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(breadcrumbSchema("/why-silver", "Why Silver")),
      },
    ],
  }),
});
      ...
      <Section tone="muted">
        ...
        <Prose className="mt-5">
          ...
          <p>
            ...
            <Link className="font-semibold text-primary underline" to="/silver-supply">
