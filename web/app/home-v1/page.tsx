...
/*
 * Previous homepage design ("v1"), preserved for A/B reference and quick
 * rollback. The live homepage is `app/page.tsx` (v2). This route
 * (`/home-v1`) is noindex and stays out of the nav and sitemap.
 * To make it the live homepage again, copy this file's body over `app/page.tsx`.
 */
